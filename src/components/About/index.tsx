        ...
        <div className="container">
          <div className={styles.context}>
            ...
            <div className={styles.textBlocks} ref={containerRef as any}>
              <div className={styles.textBlock} ref={(el) => setBlockRef(el, 0)}>
              ...
              <div className={styles.textBlock} ref={(el) => setBlockRef(el, 1)}>
              ...
              <div className={styles.textBlock} ref={(el) => setBlockRef(el, 2)}>
